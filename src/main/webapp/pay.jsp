...
<body>
	<form action="${pageContext.request.contextPath }/pay" method="post">
		...
		订单号：<INPUT TYPE="text" NAME="orderid" id="orderid" value="${orderid}">已成功提交,请选择付款方式 
		
		
		支付金额：<INPUT	TYPE="text" NAME="money" value="${sum }">元
		<div><input
						type="radio" name="yh" value="wechat" />微信</div>
		<div><input
						type="radio" name="yh" value="alipay" />支付宝</div>
		<div class="divBank">
